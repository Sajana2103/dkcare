...
const Services = () => {
  return(
    ...
    <div className="services-wrapper " style={{ padding:'10rem 0 10rem 2rem' }}>
      <h2 className="title white " id="services-title" >Services</h2>
      <div className="flex-container wrap ">
        <div className="">
          <article className=" ">
            <h2 className=" white" style={{ paddingRight: '1ch' }}>Our services can provide a vital 
lifeline for individuals and ensure that everyone has access to healthcare and other essential services they need.
          ...
          <article className="wPer3" style={{ paddingRight: '1ch' }}>
            ...
            <div className="title-bd-container">
                  <h3 className="white" style={{ paddingRight: '5px' }}>Patient & Healthcare Services</h3>
          ...
          <p className="semi-bold wPer3">We understand that working with multiple transportation providers can be
            frustrating, which is why we strive to provide a seamless and high-quality experience
            from start to finish. Our team is experienced i</p>
          <br />
